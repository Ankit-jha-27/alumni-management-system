    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <a href="/projects" className="block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-xl shadow-md text-center transition">Projects</a>
          <a href="/alumni" className="block bg-green-600 hover:bg-green-700 text-white font-semibold py-4 rounded-xl shadow-md text-center transition">CDC</a>
        </div>
